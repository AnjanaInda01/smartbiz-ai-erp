...
export default function CreatePurchasePage() {
  ...
  const loadData = async () => {
    try {
      const [suppliersRes, productsRes] = await Promise.all([getSuppliersApi(), getProductsApi()]);
  ...
  const addItem = () => append({ productId: "", qty: 1, costPrice: 0 });
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader title="Create Purchase" description="Record a purchase and update inventory" />
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="grid gap-6">
          ...
          <Card
            className="animate-slide-up shadow-premium bg-gradient-to-br from-primary/5 to-transparent"
          ...
          <div className="flex gap-4">
            <Button type="button" variant="outline" onClick={() => navigate("/staff/purchases")}>
              Cancel
            </Button>
