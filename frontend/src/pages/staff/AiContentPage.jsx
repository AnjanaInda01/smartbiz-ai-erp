...
import { generateEmailApi, generateSocialPostApi } from "@/api/aiApi";
...
export default function AiContentPage() {
  ...
  const [loading, setLoading] = useState({ email: false, socialPost: false });
  ...
  } = useForm({ resolver: zodResolver(socialPostSchema) });
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        title="AI Content"
        description="Generate emails and Facebook posts using AI"
      />
      ...
      <Tabs defaultValue="email" className="space-y-4">
        ...
        <TabsContent value="email" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Generate professional customer emails</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <form onSubmit={handleSubmitEmail(onEmailSubmit)} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="email-prompt"
                    placeholder="e.g., Write a follow-up email to thank a customer for their purchase..."
                    rows={4}
        ...
        <TabsContent value="social" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Facebook Post Writer</CardTitle>
              <CardDescription>Create engaging Facebook posts for your business</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
