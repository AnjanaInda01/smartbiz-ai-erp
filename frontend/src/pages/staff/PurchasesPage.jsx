...
import { confirmPurchaseApi, getPurchasesApi } from "@/api/purchaseApi";
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <PageHeader
        ...
        action={
          <Button
            onClick={() => navigate("/staff/purchases/create")}
      ...
      <div className="grid gap-4 md:grid-cols-4 animate-fade-in">
        ...
        <Card
          className="animate-slide-up hover:shadow-xl transition-premium bg-gradient-to-br from-primary/5 to-transparent"
      ...
      <Card className="animate-slide-up shadow-premium">
        <CardHeader>
          ...
          <CardDescription>All purchase records</CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
